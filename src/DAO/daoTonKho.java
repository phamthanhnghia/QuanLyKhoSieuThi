...
public class daoTonKho {
    ...
    public ArrayList<TonKho> getListTonKho()
    {
        ...
        while(rs.next())
        {
            result.add(new TonKho(rs.getInt("id_ton"),rs.getInt("id_lo"),rs.getTimestamp("ngay"),rs.getInt("sl_sp"),rs.getInt("id_khu_vuc")));
        }
    ...
    public boolean insertTonKho(int id_lo, Timestamp ngay, int sl_sp, int id_khu_vuc) {
    ...
    public boolean updateSoLuongTonKho(int id_lo, Timestamp ngay, int sl_sp, int id_khu_vuc) {
